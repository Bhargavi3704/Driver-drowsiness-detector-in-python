...
def sound_alarm(path):
    ...
    while alarm_status: 
        print('call')         
        playsound.playsound("C:/Users/user/Downloads/Real-TimeDrowsiness-Detection-System-main/Real-Time-Drowsiness-Detection-System-main/Alert.wav") 
    if alarm_status2:         
        print('call')         
        saying = True 
        playsound.playsound("C:/Users/user/Downloads/Real-TimeDrowsiness-Detection-System-main/Real-Time-Drowsiness-Detection-System-main/Alert.wav")
...
while True: 
    ...
    for(x,y,w,h) in rects:
        ...
        if (distance > YAWN_THRESH): 
             ...
             alarm_status2 = False 
        cv2.putText(frame, "EAR: {:.2f}".format(distance),(300,60),
                    cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,0,255),2)
        cv2.putText(frame, "YAWN: {:.2f}".format(distance),(300,60),
                    cv2.FGONT_HERSHEY_SIMPLEX,0.7,(0,0,255),2)
